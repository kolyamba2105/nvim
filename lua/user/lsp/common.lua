...
M.on_attach = function(client, bufnr)
  ...
  M.buf_set_keymap('<leader>ld', telescope.get_picker_normal('lsp_definitions'))
  M.buf_set_keymap('<leader>le', vim.diagnostic.open_float)
  M.buf_set_keymap('<leader>ll', telescope.get_picker_normal('diagnostics'))
  M.buf_set_keymap('<leader>ln', vim.lsp.buf.rename)
  M.buf_set_keymap('<leader>lq', vim.diagnostic.setloclist)
  M.buf_set_keymap('<leader>lr', telescope.get_picker_normal('lsp_references'))
  M.buf_set_keymap('<leader>ls', telescope.get_picker('lsp_document_symbols'))
  M.buf_set_keymap('<leader>lt', telescope.get_picker_normal('lsp_type_definitions'))
  M.buf_set_keymap('<leader>lw', telescope.get_picker('lsp_dynamic_workspace_symbols'))
end
