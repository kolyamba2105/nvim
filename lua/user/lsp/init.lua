...
require('lspconfig').cssls.setup(common.default_config)
...
require('lspconfig').eslint.setup(common.default_config)
require('lspconfig').html.setup(common.default_config)
require('lspconfig').jsonls.setup(common.default_config)
require('lspconfig').sumneko_lua.setup(require('user.lsp.lua'))
require('lspconfig').tailwindcss.setup(common.default_config)
require('lspconfig').yamlls.setup(common.default_config)
